...
<head>
    ...
    <title>About</title>
    <link rel="icon" href="/login/fast logo.png" type="image/x-icon">
...
<body>
    ...
    <div>
        <p>This is our Database Semester Project.<br>
            ...
            Functionalties such as Transfer from one account to another and loan and bill payments are also included.
